...
If you depend on one of these connectors, see the [deprecated connectors migration guide](docs/DEPRECATED_CONNECTORS.md) for how to pin to a release or fork the relevant connector code.
